...
const KNOCKOUT_FIXTURES = [
  ...
  // FIXED: r32-8 corrected from 2nd Grp C (Morocco) to 2nd Grp B (Bosnia-Herzegovina) — USA (1st Grp D) vs Bosnia
  { id: 'r32-8',  stage: 'Round of 32', homeSource: { type: 'group',   group: 'D', pos: 1 }, awaySource: { type: 'group',   group: 'B', pos: 2 }, date: '2026-07-01', timeLocal: '19:00', tz: 'ET', venue: 'Lincoln Financial Field',  city: 'Philadelphia, PA',      ...BC.fs1 },
