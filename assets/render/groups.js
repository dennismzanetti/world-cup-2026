...
// useUserPredictions: if truthy, overlays predicted scores before calling calcPoints
export function renderStandingsGrid(container, buildGroups, groupMatches, userPredictions) {
  if (!container) return;
  container.innerHTML = '';
